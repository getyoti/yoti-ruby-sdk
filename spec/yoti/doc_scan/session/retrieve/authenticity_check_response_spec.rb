...
describe 'Yoti::DocScan::Session::Retrieve::AuthenticityCheckResponse' do
  let(:check_response) do
    Yoti::DocScan::Session::Retrieve::AuthenticityCheckResponse.new(
      'type' => 'some-type',
      'id' => 'some-id',
      'state' => 'some-state',
  ...
  describe '.generated_media' do
    it 'should return list of generated media' do
      ...
      media.each do |media_item|
        expect(media_item).to be_a(Yoti::DocScan::Session::Retrieve::GeneratedMedia)
      end
    end

    it 'should return default to empty array' do
      check_response = Yoti::DocScan::Session::Retrieve::AuthenticityCheckResponse.new({})
      media = check_response.generated_media
