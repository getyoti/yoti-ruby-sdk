...
describe 'Yoti::DocScan::Session::Retrieve::SupplementaryDocumentTextExtractionTaskResponse' do
  let(:task_response) do
    Yoti::DocScan::Session::Retrieve::SupplementaryDocumentTextExtractionTaskResponse.new(
      'type' => 'some-type',
      'id' => 'some-id',
      'state' => 'some-state',
  ...
  describe '.generated_media' do
    ...
    it 'should return default to empty array' do
      task_response = Yoti::DocScan::Session::Retrieve::SupplementaryDocumentTextExtractionTaskResponse.new({})
      media = task_response.generated_media
  ...
  describe '.generated_checks' do
    it 'should return list of generated checks' do
      ...
      expect(checks[0]).to be_a(Yoti::DocScan::Session::Retrieve::GeneratedSupplementaryDocumentTextDataCheckResponse)
