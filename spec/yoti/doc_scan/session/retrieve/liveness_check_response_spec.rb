...
describe 'Yoti::DocScan::Session::Retrieve::LivenessCheckResponse' do
  let(:check_response) do
    Yoti::DocScan::Session::Retrieve::LivenessCheckResponse.new(
      'type' => 'some-type',
      'id' => 'some-id',
      'state' => 'some-state',
  ...
  describe '.generated_media' do
    ...
    it 'should return default to empty array' do
      check_response = Yoti::DocScan::Session::Retrieve::LivenessCheckResponse.new({})
      media = check_response.generated_media
