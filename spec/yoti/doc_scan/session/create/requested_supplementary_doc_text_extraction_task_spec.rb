...
describe 'Yoti::DocScan::Session::Create::RequestedSupplementaryDocTextExtractionTask' do
  describe 'with manual check always' do
    it 'serializes correctly' do
      check = Yoti::DocScan::Session::Create::RequestedSupplementaryDocTextExtractionTask
              .builder
