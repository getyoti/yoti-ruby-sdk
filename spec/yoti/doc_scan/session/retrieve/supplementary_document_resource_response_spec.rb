...
describe 'Yoti::DocScan::Session::Retrieve::SupplementaryDocumentResourceResponse' do
  let(:resource_response) do
    Yoti::DocScan::Session::Retrieve::SupplementaryDocumentResourceResponse.new(
  ...
  describe '.document_file' do
    it 'should return document file' do
      expect(resource_response.document_file).to be_a(Yoti::DocScan::Session::Retrieve::FileResponse)
    end
  end
  ...
  describe '.text_extraction_tasks' do
    it 'should return array of text extraction tasks' do
      expect(resource_response.text_extraction_tasks.count).to eql(1)
      expect(resource_response.text_extraction_tasks).to all(be_a(Yoti::DocScan::Session::Retrieve::SupplementaryDocumentTextExtractionTaskResponse))
    end
  end
end
